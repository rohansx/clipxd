...
- **Not yet (deferred by design):** CloakPipe is a stubbed manifest (Phase 4); there is no capture backend (Phase 2/3); the searchable library and share-page/sidecar service are Phase 5 / 1.5. None are needed for the headline.
